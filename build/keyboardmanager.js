...
exports.KeyboardManager = function (options) {
    /**
 ...
 *```
 */
exports.KeyboardManager.prototype.get_default_common_shortcuts = function () {
    return {
...
exports.KeyboardManager.prototype.get_default_edit_shortcuts = function () {
    return {
...
exports.KeyboardManager.prototype.get_default_command_shortcuts = function () {
    return {
        'cmdtrl-shift-p': 'ipython.command-palette',
...
exports.KeyboardManager.prototype.bind_events = function () {
    var that = this;
...
exports.KeyboardManager.prototype.set_notebook = function (notebook) {
    this.notebook = notebook;
    this.actions.extend_env({ notebook: notebook });
};
exports.KeyboardManager.prototype.set_quickhelp = function (notebook) {
    this.actions.extend_env({ quick_help: notebook });
};
exports.KeyboardManager.prototype.handle_keydown = function (event) {
...
exports.KeyboardManager.prototype.edit_mode = function () {
    this.last_mode = this.mode;
    this.mode = 'edit';
};
exports.KeyboardManager.prototype.command_mode = function () {
    this.last_mode = this.mode;
    this.mode = 'command';
};
exports.KeyboardManager.prototype.enable = function () {
    this.enabled = true;
};
exports.KeyboardManager.prototype.disable = function () {
    this.enabled = false;
};
exports.KeyboardManager.prototype.register_events = function (e) {
    e = $(e);
    var that = this;
