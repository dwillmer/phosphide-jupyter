 ...
 */
exports.load_extension = function (extension) {
...
exports.load_extensions = function () {
    return Promise.all(Array.prototype.map.call(arguments, exports.load_extension)).catch(function (err) {
...
exports.load_extensions_from_config = load_extensions_from_config;
//============================================================================
...
exports.fixCarriageReturn = fixCarriageReturn;
...
exports.url_join_encode = function () {
     ...
     */
    return exports.encode_uri_components(exports.url_path_join.apply(null, arguments));
};
