...
"use strict";
exports.CellToolbar = function (options) {
    /**
     * Constructor
     *
     * Parameters:
     ...
     */
    exports.CellToolbar._instances.push(this);
...
exports.CellToolbar.prototype.create_element = function () {
...
exports.CellToolbar.global_hide = function () {
    $('body').removeClass('ctb_global_show');
};
exports.CellToolbar.global_show = function () {
    $('body').addClass('ctb_global_show');
};
exports.CellToolbar.prototype.hide = function () {
    this.element.removeClass('ctb_show');
};
exports.CellToolbar.prototype.show = function () {
 ...
 * @type Dict
 */
exports.CellToolbar._callback_dict = {};
/**
 ...
 * @type List
 */
exports.CellToolbar._ui_controls_list = [];
/**
 ...
 * @type List
 */
exports.CellToolbar._instances = [];
/**
 ...
 */
exports.CellToolbar.register_callback = function (name, callback, cell_types) {
    // Overwrite if it already exists.
    exports.CellToolbar._callback_dict[name] = cell_types ? { callback: callback, cell_types: cell_types } : callback;
};
/**
 ...
 */
exports.CellToolbar.register_preset = function (name, preset_list, notebook) {
    exports.CellToolbar._presets[name] = preset_list;
    ...
    if (notebook && notebook.metadata && notebook.metadata.celltoolbar === name) {
        exports.CellToolbar.activate_preset(name);
    }
};
/**
 ...
 *
 **/
exports.CellToolbar.unregister_preset = function (name) {
    if (exports.CellToolbar._presets[name]) {
        delete exports.CellToolbar._presets[name];
 ...
 * @static
 */
exports.CellToolbar.list_presets = function () {
    var keys = [];
    for (var k in exports.CellToolbar._presets) {
        keys.push(k);
    }
    return keys;
};
 ...
 */
exports.CellToolbar.activate_preset = function (preset_name) {
    var preset = exports.CellToolbar._presets[preset_name];
    if (preset !== undefined) {
        exports.CellToolbar._ui_controls_list = preset;
        exports.CellToolbar.rebuild_all();
    }
 ...
 *
 */
exports.CellToolbar.rebuild_all = function () {
    for (var i = 0; i < exports.CellToolbar._instances.length; i++) {
        exports.CellToolbar._instances[i].rebuild();
    }
};
/**
 ...
 * @method rebuild
 */
exports.CellToolbar.prototype.rebuild = function () {
    /**
    ...
    var callbacks = exports.CellToolbar._callback_dict;
    var preset = exports.CellToolbar._ui_controls_list;
    ...
    for (var i = 0; i < preset.length; i++) {
        ...
        if (typeof callback === 'object') {
            if (callback.cell_types.indexOf(this.cell.cell_type) === -1)
                continue;
 ...
 *
 */
exports.CellToolbar.utils.checkbox_ui_generator = function (name, setter, getter) {
 ...
 *
 */
exports.CellToolbar.utils.input_ui_generator = function (name, setter, getter) {
    return function (div, cell, celltoolbar) {
        var button_container = $(div);
 ...
 *
 */
exports.CellToolbar.utils.select_ui_generator = function (list_list, setter, getter, label) {
    label = label || "";
    return function (div, cell, celltoolbar) {
        var button_container = $(div);
...
//# sourceMappingURL=celltoolbar.js.map