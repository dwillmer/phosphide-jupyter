...
exports.Completer = function (cell, events) {
    this.cell = cell;
...
exports.Completer.prototype.startCompletion = function () {
    /**
...
//
exports.Completer.reinvoke_re = /[%0-9a-z._/\\:~-]/i;
exports.Completer.prototype.reinvoke = function (pre_cursor, block, cursor) {
    return exports.Completer.reinvoke_re.test(pre_cursor);
};
/**
 *
 ...
 * shared start
 **/
exports.Completer.prototype.carry_on_completion = function (first_invocation) {
    var _this = this;
    /**
    ...
    if (this.skip_kernel_completion) {
        ...
        this.cell.kernel.complete(request).then(function (content) {
            _this.finish_completing(content);
        });
    }
};
exports.Completer.prototype.finish_completing = function (content) {
    /**
    ...
    var pos = this.editor.cursorCoords(utils.from_absolute_cursor_pos(this.editor, start));
    var left = pos.left - 3;
    var top;
...
exports.Completer.prototype.insert = function (completion) {
    this.editor.replaceRange(completion.str, completion.from, completion.to);
};
exports.Completer.prototype.build_gui_list = function (completions) {
...
exports.Completer.prototype.close = function () {
    this.done = true;
    $('#complete').remove();
...
exports.Completer.prototype.pick = function () {
    this.insert(this.raw_result[this.sel[0].selectedIndex]);
    this.close();
};
exports.Completer.prototype.keydown = function (event) {
...
exports.Completer.prototype.keypress = function (event) {
    /**
