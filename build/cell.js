...
exports.Cell = function (options) {
    ...
    var config = utils.mergeopt(exports.Cell, options.config);
...
if (utils.browser[0] == "Safari") {
    exports.Cell.options_default.cm_config.dragDrop = false;
}
/**
 ...
 */
exports.Cell.prototype.create_element = function () {
};
exports.Cell.prototype.init_classes = function () {
    /**
 ...
 * @method bind_events
 */
exports.Cell.prototype.bind_events = function () {
    var that = this;
 ...
 */
exports.Cell.prototype.handle_codemirror_keyevent = function (editor, event) {
 ...
 */
exports.Cell.prototype.select = function () {
    if (!this.selected) {
        this.element.addClass('selected');
 ...
 * @return is the action being taken
 */
exports.Cell.prototype.unselect = function (leave_selected) {
 ...
 * @method execute
 */
exports.Cell.prototype.execute = function () {
    return;
};
/**
 ...
 * @return is the action being taken
 */
exports.Cell.prototype.render = function () {
    if (!this.rendered) {
        this.element.addClass('rendered');
 ...
 * @return is the action being taken
 */
exports.Cell.prototype.unrender = function () {
    if (this.rendered) {
        this.element.addClass('unrendered');
 ...
 * @return {Boolean} `true` if CodeMirror should ignore the event, `false` Otherwise
 */
exports.Cell.prototype.handle_keyevent = function (editor, event) {
 ...
 * @return {Boolean}
 */
exports.Cell.prototype.at_top = function () {
 ...
 * @return {Boolean}
 * */
exports.Cell.prototype.at_bottom = function () {
    var cm = this.code_mirror;
    var cursor = cm.getCursor();
 ...
 * @return is the action being taken
 */
exports.Cell.prototype.command_mode = function () {
    if (this.mode !== 'command') {
        this.mode = 'command';
        return true;
    }
 ...
 * @return is the action being taken
 */
exports.Cell.prototype.edit_mode = function () {
    if (this.mode !== 'edit') {
        this.mode = 'edit';
        return true;
    }
...
exports.Cell.prototype.ensure_focused = function () {
 ...
 * @method focus_cell
 */
exports.Cell.prototype.focus_cell = function () {
    this.element.focus();
};
/**
 ...
 * @method focus_editor
 */
exports.Cell.prototype.focus_editor = function () {
    this.refresh();
 ...
 * @method refresh
 */
exports.Cell.prototype.refresh = function () {
    if (this.code_mirror) {
 ...
 * @method get_text
 */
exports.Cell.prototype.get_text = function () {
};
/**
 * should be overritten by subclass
 * @method set_text
 * @param {string} text
 */
exports.Cell.prototype.set_text = function (text) {
};
/**
 * should be overritten by subclass
 ...
 * @method toJSON
 **/
exports.Cell.prototype.toJSON = function () {
    var data = {};
 ...
 * @method fromJSON
 **/
exports.Cell.prototype.fromJSON = function (data) {
 ...
 **/
exports.Cell.prototype.is_splittable = function () {
 ...
 * @method is_mergeable
 **/
exports.Cell.prototype.is_mergeable = function () {
    return this.is_deletable();
};
/**
 ...
 * @method is_deletable
 **/
exports.Cell.prototype.is_deletable = function () {
 ...
 **/
exports.Cell.prototype.get_pre_cursor = function () {
 ...
 **/
exports.Cell.prototype.get_post_cursor = function () {
    var cursor = this.code_mirror.getCursor();
 ...
 **/
exports.Cell.prototype.show_line_numbers = function (value) {
 ...
 **/
exports.Cell.prototype.toggle_line_numbers = function () {
 ...
 **/
exports.Cell.prototype.force_highlight = function (mode) {
 ...
 */
exports.Cell.prototype.auto_highlight = function () {
    //
};
/**
 ...
 **/
exports.Cell.prototype._auto_highlight = function (modes) {
    /**
...
exports.UnrecognizedCell = function (options) {
    /** Constructor for unrecognized cells */
    exports.Cell.apply(this, arguments);
    this.cell_type = 'unrecognized';
    this.celltoolbar = null;
    this.data = {};
    Object.seal(this);
};
exports.UnrecognizedCell.prototype = Object.create(exports.Cell.prototype);
// cannot merge or split unrecognized cells
exports.UnrecognizedCell.prototype.is_mergeable = function () {
    return false;
};
exports.UnrecognizedCell.prototype.is_splittable = function () {
    return false;
};
exports.UnrecognizedCell.prototype.toJSON = function () {
    /**
     * deepcopy the metadata so copied cells don't share the same object
     */
    return JSON.parse(JSON.stringify(this.data));
};
exports.UnrecognizedCell.prototype.fromJSON = function (data) {
    this.data = data;
    if (data.metadata !== undefined) {
        this.metadata = data.metadata;
    }
...
exports.UnrecognizedCell.prototype.create_element = function () {
    exports.Cell.prototype.create_element.apply(this, arguments);
...
exports.UnrecognizedCell.prototype.bind_events = function () {
    exports.Cell.prototype.bind_events.apply(this, arguments);
    var cell = this;
