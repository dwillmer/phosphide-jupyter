...
"use strict";
exports.ActionHandler = function (env) {
    this.env = env || {};
    Object.seal(this);
};
/**
...
exports.ActionHandler.prototype._actions = fun();
/**
 *  extend the environment variable that will be pass to handlers
 **/
exports.ActionHandler.prototype.extend_env = function (env) {
    for (var k in env) {
        this.env[k] = env[k];
    }
};
exports.ActionHandler.prototype.register = function (action, name, prefix) {
    /**
...
exports.ActionHandler.prototype.normalise = function (data) {
    /**
...
exports.ActionHandler.prototype.get_name = function (name_or_data) {
    /**
...
exports.ActionHandler.prototype.get = function (name) {
    return this._actions[name];
};
exports.ActionHandler.prototype.call = function (name, event, env) {
    return this._actions[name].handler(env || this.env, event);
};
exports.ActionHandler.prototype.exists = function (name) {
