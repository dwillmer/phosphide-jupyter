...
// tooltip constructor
exports.Tooltip = function (events, element) {
    var that = this;
    this.events = events;
    ...
    }).append($('<span/>').text('Expand').addClass('ui-icon').addClass('ui-icon-plus'));
    // close the tooltip
...
exports.Tooltip.prototype.is_visible = function () {
    return !this._hidden;
};
exports.Tooltip.prototype.showInPager = function (cell) {
    /**
...
exports.Tooltip.prototype.expand = function () {
...
exports.Tooltip.prototype._hide = function () {
    this._hidden = true;
...
// false.
exports.Tooltip.prototype.remove_and_cancel_tooltip = function (force) {
    /**
...
exports.Tooltip.prototype.cancel_pending = function () {
...
exports.Tooltip.prototype.pending = function (cell, hide_if_no_docstring) {
    var that = this;
...
exports.Tooltip.last_token_re = /[a-z_][0-9a-z._]*$/gi;
exports.Tooltip.prototype._request_tooltip = function (cell, text, cursor_pos) {
    var _this = this;
    var request = { code: text,
        cursor_pos: cursor_pos,
        detail_level: 0 };
    cell.kernel.inspect(request).then(function (contents) {
        _this._show(contents);
    });
};
// make an immediate completion request
exports.Tooltip.prototype.request = function (cell, hide_if_no_docstring) {
    /**
     * request(codecell)
...
exports.Tooltip.prototype.cancel_stick = function () {
...
exports.Tooltip.prototype.stick = function (time) {
...
exports.Tooltip.prototype._show = function (reply) {
    /**
